# phone automation tiktok-delete-comment-asia

Delete TikTok comments by keywords — Asia region.
...
```bash
geelark-cli phone automation tiktok-delete-comment-asia --id "557536075321468390" --schedule-at 1741846843 --keywords "hello,world"
```

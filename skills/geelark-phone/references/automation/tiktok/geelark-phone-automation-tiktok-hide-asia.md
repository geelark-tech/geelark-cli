# phone automation tiktok-hide-asia

Hide TikTok videos — Asia region.
...
```bash
geelark-cli phone automation tiktok-hide-asia --id "557536075321468390" --schedule-at 1741846843
```
